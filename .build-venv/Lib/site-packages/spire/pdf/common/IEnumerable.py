...
class IEnumerable (SpireObject, Generic[T]) :
    ...
    def GetEnumerator(self)->IEnumerator[T]:
        ...
        """
        dlllib.spr_pdf_IEnumerable_GetEnumerator.argtypes=[c_void_p]
        dlllib.spr_pdf_IEnumerable_GetEnumerator.restype=c_void_p
        intPtr = CallCFunction(dlllib.spr_pdf_IEnumerable_GetEnumerator,self.Ptr)
