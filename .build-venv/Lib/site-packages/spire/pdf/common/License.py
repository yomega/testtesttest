...
class License (SpireObject) :
    ...
    def SetLicenseFileFullPathByDLLHander(dllhander, licenseFileFullPath:str):
        if __package__ == "spire.doc.common" or __package__ == "spire.presentation.common":
            ...
            if dllhander != None:
                dllhander.spr_pdf_LISetLicenseFileFullPath.argtypes=[ c_char_p]
                dllhander.spr_pdf_LISetLicenseFileFullPath( licenseFileFullPathPtr)
        else:
            if dllhander != None:
                dllhander.spr_pdf_LISetLicenseFileFullPath.argtypes=[ c_wchar_p]
                dllhander.spr_pdf_LISetLicenseFileFullPath( licenseFileFullPath)
    ...
    def SetLicenseFileNameByDLLHander(dllhander, licenseFileName:str):
        if __package__ == "spire.doc.common" or __package__ == "spire.presentation.common":
            licenseFileNamePtr = StrToPtr(licenseFileName)
            if dllhander != None:
                dllhander.spr_pdf_LISetLicenseFileName.argtypes=[ c_char_p]
                dllhander.spr_pdf_LISetLicenseFileName(licenseFileNamePtr)
        else:
            if dllhander != None:
                dllhander.spr_pdf_LISetLicenseFileName.argtypes=[ c_wchar_p]
                dllhander.spr_pdf_LISetLicenseFileName( licenseFileName)
    ...
    def SetLicenseFileStreamByDLLHander(dllhander, stream:Stream):
        if dllhander != None:
            ...
            dllhander.spr_pdf_LISetLicenseFileStream.argtypes=[ c_void_p]
            dllhander.spr_pdf_LISetLicenseFileStream( intPtrobj)
    ...
    def SetLicenseKeyByDLLHander(dllhander, key:str):
        if __package__ == "spire.doc.common" or __package__ == "spire.presentation.common":
            keyPtr = StrToPtr(key)
            if dllhander != None:
                dllhander.spr_pdf_LISetLicenseKey.argtypes=[ c_char_p]
                dllhander.spr_pdf_LISetLicenseKey(keyPtr)
        else:
            if dllhander != None:
                dllhander.spr_pdf_LISetLicenseKey.argtypes=[ c_wchar_p]
                dllhander.spr_pdf_LISetLicenseKey( key)
    ...
    def ClearLicenseByDLLHander(dllhander):
        if dllhander != None:
            dllhander.spr_pdf_LIClearLicense( )
    ...
    def GetLicenseFileNameByDLLHander(dllhander)->str:
        if dllhander != None:
            dllhander.spr_pdf_LIGetLicenseFileName.argtypes=[c_void_p]
            return dllhander.spr_pdf_LIGetLicenseFileName( )
        return None